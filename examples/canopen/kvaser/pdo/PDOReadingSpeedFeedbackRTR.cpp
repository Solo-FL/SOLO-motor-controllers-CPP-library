/**
 *******************************************************************************
 * @file    PDOReadingSpeedFeedbackRTR.cpp
 * @authors SOLO Motor Controllers
 * @brief   PDO Reading SpeedFeedback using RTR
 * 
 * @date    Date: 2024
 * @version 1.3.0
 * *******************************************************************************    
...
//Getting the Speed Feedback after RTR Message
...
int main(void){
	...
	solo->SendPdoRtr(PdoParameterName::speedFeedback);
	Sleep(50);
