/**
 *******************************************************************************
 * @file    PDOReadingTorqueFeedback4Sync.cpp
 * @authors SOLO Motor Controllers
 * @brief   PDO Reading TorqueFeedback with 4 Sync
 * 
 * @date    Date: 2024
 * @version 1.3.0
 * *******************************************************************************    
...
//Getting the Torque Feedback after 4 SYNC Message
...
int main(void){
	...
	config.parameterName = PdoParameterName::quadratureCurrentIqFeedback;
	...
	//solo->pdoParameterCobIdByPdoParameterName[PdoParameterName::quadratureCurrentIqFeedback] = 0x280;
    ...
    float myRead = solo->GetPdoQuadratureCurrentIqFeedback(error);
    ...
    //read the older value in the PDO buffer
    myRead = solo->GetPdoQuadratureCurrentIqFeedback(error);
	std::cout << "READ VALUE: "<< myRead << " ERROR: "<< error <<"\n"; 
