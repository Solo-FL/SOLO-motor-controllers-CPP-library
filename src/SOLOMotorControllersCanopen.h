...
public:
    SOLOMotorControllersCanopen(CommunicationInterface* ci, unsigned char _deviceAddress = 0, unsigned char _chipSelectPin = 9, SOLOMotorControllers::CanbusBaudrate _baudrate = SOLOMotorControllers::CanbusBaudrate::rate1000,  long _countTimeout = 6000) ; //SOLOMotorControllers::CanbusBaudrate , ? 
...
/** @addtogroup SOLOMotorControllers_Write_Functions SOLOMotorControllers Write Functions
  ...
  */
    ...
    bool ResetFactory();
    bool ResetDeviceAddress(int &error) { return true; };
    bool ResetDeviceAddress() { return true; };
