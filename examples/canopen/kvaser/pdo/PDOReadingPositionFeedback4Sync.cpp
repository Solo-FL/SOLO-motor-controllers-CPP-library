/**
 *******************************************************************************
 * @file    PDOReadingPositionFeedback4Sync.cpp
 * @authors SOLO Motor Controllers
 * @brief   PDO Reading PositionFeedback with 4 Sync
 * 
 * @date    Date: 2024
 * @version 1.3.0
 * *******************************************************************************    
...
//Getting the Position Feedback after 4 SYNC Message
...
int main(void){
	std::cout << "PDOReadingPositionFeedback4Sync Kvaser Test" << std::endl;
