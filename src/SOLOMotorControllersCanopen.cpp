...
SOLOMotorControllersCanopen::SOLOMotorControllersCanopen(CommunicationInterface* ci, unsigned char _deviceAddress , unsigned char _chipSelectPin, SOLOMotorControllers::CanbusBaudrate _baudrate, long _countTimeout)
    : comIf(ci)
{
    uint16_t baudrate = 1000;
    timeout = _countTimeout;
...
bool SOLOMotorControllersCanopen::SetOutputPwmFrequencyKhz(long outputPwmFrequencyKhz, int &error) 
{
    ...
    return comIf->CANOpenTransmit(Address,Object_OutputPwmFrequencyKhz, 0x00,informatrionToSend,error);
}
...
long SOLOMotorControllersCanopen::GetReadErrorRegister(int &error)
{
    ...
    error = SOLOMotorControllers::Error::noProcessedCommand;
    if(comIf->CANOpenReceive(Address, Object_ReadErrorRegister, 0x00 , informationToSend, informationReceived, error)){
...
long SOLOMotorControllersCanopen::GetGuardTime(int &error)
{
    ...
    uint8_t  informationReceived[4] = {0x00,0x00,0x00,0x00};
    error = SOLOMotorControllers::Error::noProcessedCommand;
    if(comIf->CANOpenReceive(Address, Object_GuardTime, 0x00, informationToSend, informationReceived, error)){
        return ( soloUtils->ConvertToLong(informationReceived) ) ;
    }
    return -1;
}
...
long SOLOMotorControllersCanopen::GetLifeTimeFactor(int &error)
{
    ...
    uint8_t  informationReceived[4] = {0x00,0x00,0x00,0x00};
    error = SOLOMotorControllers::Error::noProcessedCommand;
    if(comIf->CANOpenReceive(Address, Object_LifeTimeFactor, 0x00, informationToSend, informationReceived, error)){
        return ( soloUtils->ConvertToLong(informationReceived) ) ;
    }
    return -1;
}
...
long SOLOMotorControllersCanopen::GetProducerHeartbeatTime(int &error)
{
    ...
    uint8_t  informationReceived[4] = {0x00,0x00,0x00,0x00};
    error = SOLOMotorControllers::Error::noProcessedCommand;
    if(comIf->CANOpenReceive(Address, Object_ProducerHeartbeatTime, 0x00, informationToSend, informationReceived, error)){
        return ( soloUtils->ConvertToLong(informationReceived) ) ;
    }
    return -1;
}
...
long SOLOMotorControllersCanopen::GetDeviceAddress(int &error)
{
    ...
    uint8_t  informationReceived[4] = {0x00,0x00,0x00,0x00};
    error = SOLOMotorControllers::Error::noProcessedCommand;
    if(comIf->CANOpenReceive(Address, Object_SetDeviceAddress, 0x00, informationToSend, informationReceived, error)){
        return ( soloUtils->ConvertToLong(informationReceived) ) ;
    }
    return -1;
}
...
float SOLOMotorControllersCanopen::GetPhaseAVoltage(int &error)
{
    ...
    uint8_t  informationReceived[4] = {0x00,0x00,0x00,0x00};
    error = SOLOMotorControllers::Error::noProcessedCommand;
    if(comIf->CANOpenReceive(Address, Object_PhaseAVoltage, 0x00, informationToSend, informationReceived, error)){
...
float SOLOMotorControllersCanopen::GetPhaseBVoltage(int &error)
{
    ...
    uint8_t  informationReceived[4] = {0x00,0x00,0x00,0x00};
    error = SOLOMotorControllers::Error::noProcessedCommand;
    if(comIf->CANOpenReceive(Address, Object_PhaseBVoltage, 0x00, informationToSend, informationReceived, error)){
        return ( soloUtils->ConvertToFloat(informationReceived) ) ;
    }
    return -1.0;
}
...
float SOLOMotorControllersCanopen::GetPhaseACurrent(int &error)
{
    ...
    uint8_t  informationReceived[4] = {0x00,0x00,0x00,0x00};
    error = SOLOMotorControllers::Error::noProcessedCommand;
    if(comIf->CANOpenReceive(Address, Object_PhaseACurrent, 0x00, informationToSend, informationReceived, error)){
        return ( soloUtils->ConvertToFloat(informationReceived) ) ;
    }
    return -1.0;
}
...
float SOLOMotorControllersCanopen::GetPhaseBCurrent(int &error)
{
    ...
    uint8_t  informationReceived[4] = {0x00,0x00,0x00,0x00};
    error = SOLOMotorControllers::Error::noProcessedCommand;
    if(comIf->CANOpenReceive(Address, Object_PhaseBCurrent, 0x00, informationToSend, informationReceived, error)){
        return ( soloUtils->ConvertToFloat(informationReceived) ) ;
    }
    return -1.0;
}
...
float SOLOMotorControllersCanopen::GetBusVoltage(int &error)
{
    ...
    uint8_t  informationReceived[4] = {0x00,0x00,0x00,0x00};
    error = SOLOMotorControllers::Error::noProcessedCommand;
    if(comIf->CANOpenReceive(Address, Object_BusVoltage, 0x00, informationToSend, informationReceived, error)){
        return ( soloUtils->ConvertToFloat(informationReceived) ) ;
    }
    return -1.0;
}
...
float SOLOMotorControllersCanopen::GetDcMotorCurrentIm(int &error)
{
    ...
    uint8_t  informationReceived[4] = {0x00,0x00,0x00,0x00};
    error = SOLOMotorControllers::Error::noProcessedCommand;
    if(comIf->CANOpenReceive(Address, Object_DcMotorCurrentIm, 0x00, informationToSend, informationReceived, error)){
        return ( soloUtils->ConvertToFloat(informationReceived) ) ;
    }
    return -1.0 ;
}
...
float SOLOMotorControllersCanopen::GetDcMotorVoltageVm(int &error)
{
    ...
    uint8_t  informationReceived[4] = {0x00,0x00,0x00,0x00};
    error = SOLOMotorControllers::Error::noProcessedCommand;
    if(comIf->CANOpenReceive(Address, Object_DcMotorVoltageVm, 0x00, informationToSend, informationReceived, error)){
        return ( soloUtils->ConvertToFloat(informationReceived) ) ;
    }
    return -1.0 ;
}
...
float SOLOMotorControllersCanopen::GetSpeedControllerKp(int &error)
{
    ...
    uint8_t  informationReceived[4] = {0x00,0x00,0x00,0x00};
    error = SOLOMotorControllers::Error::noProcessedCommand;
    if(comIf->CANOpenReceive(Address, Object_SpeedControllerKp, 0x00, informationToSend, informationReceived, error)){
        return ( soloUtils->ConvertToFloat(informationReceived) ) ;
    }
    return -1.0 ;
}
...
float SOLOMotorControllersCanopen::GetSpeedControllerKi(int &error)
{
    ...
    uint8_t  informationReceived[4] = {0x00,0x00,0x00,0x00};
    error = SOLOMotorControllers::Error::noProcessedCommand;
    if(comIf->CANOpenReceive(Address, Object_SpeedControllerKi, 0x00, informationToSend, informationReceived, error)){
        return ( soloUtils->ConvertToFloat(informationReceived) ) ;
    }
    return -1.0 ;
}
...
long SOLOMotorControllersCanopen::GetOutputPwmFrequencyKhz(int &error)
{
    ...
    uint8_t  informationReceived[4] = {0x00,0x00,0x00,0x00};
    error = SOLOMotorControllers::Error::noProcessedCommand;
    if(comIf->CANOpenReceive(Address, Object_OutputPwmFrequencyKhz, 0x00, informationToSend, informationReceived, error)){
        return ( soloUtils->ConvertToLong(informationReceived) ) ;
    }
    return -1 ;
}
...
float SOLOMotorControllersCanopen::GetCurrentLimit(int &error)
{
    ...
    uint8_t  informationReceived[4] = {0x00,0x00,0x00,0x00};
    error = SOLOMotorControllers::Error::noProcessedCommand;
    if(comIf->CANOpenReceive(Address, Object_CurrentLimit, 0x00, informationToSend, informationReceived, error)){
        return ( soloUtils->ConvertToFloat(informationReceived) ) ;
    }
    return -1.0 ;
}
...
float SOLOMotorControllersCanopen::GetQuadratureCurrentIqFeedback(int &error)
{
    ...
    uint8_t  informationReceived[4] = {0x00,0x00,0x00,0x00};
    error = SOLOMotorControllers::Error::noProcessedCommand;
    if(comIf->CANOpenReceive(Address, Object_QuadratureCurrentIqFeedback, 0x00, informationToSend, informationReceived, error)){
        return ( soloUtils->ConvertToFloat(informationReceived) ) ;
    }
    return -1.0 ;
}
...
float SOLOMotorControllersCanopen::GetMagnetizingCurrentIdFeedback(int &error)
{
    ...
    uint8_t  informationReceived[4] = {0x00,0x00,0x00,0x00};
    error = SOLOMotorControllers::Error::noProcessedCommand;
    if(comIf->CANOpenReceive(Address, Object_MagnetizingCurrentIdFeedback, 0x00, informationToSend, informationReceived, error)){
        return ( soloUtils->ConvertToFloat(informationReceived) ) ;
    }
    return -1.0 ;
}
...
long SOLOMotorControllersCanopen::GetMotorPolesCounts(int &error)
{
    ...
    uint8_t  informationReceived[4] = {0x00,0x00,0x00,0x00};
    error = SOLOMotorControllers::Error::noProcessedCommand;
    if(comIf->CANOpenReceive(Address, Object_MotorPolesCounts, 0x00, informationToSend, informationReceived, error)){
        return ( soloUtils->ConvertToLong(informationReceived) ) ;
    }
    return -1;
}
...
long SOLOMotorControllersCanopen::GetIncrementalEncoderLines(int &error)
{
    ...
    uint8_t  informationReceived[4] = {0x00,0x00,0x00,0x00};
    error = SOLOMotorControllers::Error::noProcessedCommand;
    if(comIf->CANOpenReceive(Address, Object_IncrementalEncoderLines, 0x00, informationToSend, informationReceived, error)){
        return ( soloUtils->ConvertToLong(informationReceived) ) ;
    }
    return -1;
}
...
float SOLOMotorControllersCanopen::GetCurrentControllerKp(int &error)
{
    ...
    uint8_t  informationReceived[4] = {0x00,0x00,0x00,0x00};
    error = SOLOMotorControllers::Error::noProcessedCommand;
    if(comIf->CANOpenReceive(Address, Object_CurrentControllerKp, 0x00, informationToSend, informationReceived, error)){
        return ( soloUtils->ConvertToFloat(informationReceived) ) ;
    }
    return -1.0;
}
...
float SOLOMotorControllersCanopen::GetCurrentControllerKi(int &error)
{
    ...
    uint8_t  informationReceived[4] = {0x00,0x00,0x00,0x00};
    error = SOLOMotorControllers::Error::noProcessedCommand;
    if(comIf->CANOpenReceive(Address, Object_CurrentControllerKi, 0x00 , informationToSend, informationReceived, error)){
        return ( soloUtils->ConvertToFloat(informationReceived) ) ;
    }
    return -1.0;
}
...
float SOLOMotorControllersCanopen::GetBoardTemperature(int &error)
{
    ...
    uint8_t  informationReceived[4] = {0x00,0x00,0x00,0x00};
    error = SOLOMotorControllers::Error::noProcessedCommand;
    if(comIf->CANOpenReceive(Address, Object_BoardTemperature, 0x00, informationToSend, informationReceived, error)){
        return ( soloUtils->ConvertToFloat(informationReceived) ) ;
    }
    return -1.0;
}
...
float SOLOMotorControllersCanopen::GetMotorResistance(int &error)
{
    ...
    uint8_t  informationReceived[4] = {0x00,0x00,0x00,0x00};
    error = SOLOMotorControllers::Error::noProcessedCommand;
    if(comIf->CANOpenReceive(Address, Object_MotorResistance, 0x00, informationToSend, informationReceived, error)){
        return ( soloUtils->ConvertToFloat(informationReceived) ) ;
    }
    return -1.0;
}
...
float SOLOMotorControllersCanopen::GetMotorInductance(int &error)
{
    ...
    uint8_t  informationReceived[4] = {0x00,0x00,0x00,0x00};
    error = SOLOMotorControllers::Error::noProcessedCommand;
    if(comIf->CANOpenReceive(Address, Object_MotorInductance, 0x00, informationToSend, informationReceived, error)){
        return ( soloUtils->ConvertToFloat(informationReceived) ) ;
    }
    return -1.0;
}
...
long SOLOMotorControllersCanopen::GetSpeedFeedback(int &error)
{
    ...
    uint8_t  informationReceived[4] = {0x00,0x00,0x00,0x00};
    error = SOLOMotorControllers::Error::noProcessedCommand;
    if(comIf->CANOpenReceive(Address, Object_SpeedFeedback, 0x00, informationToSend, informationReceived, error)){
        return ( soloUtils->ConvertToLong(informationReceived) ) ;
    }
    return -1;
}
...
long SOLOMotorControllersCanopen::GetMotorType(int &error)
{
    ...
    uint8_t  informationReceived[4] = {0x00,0x00,0x00,0x00};
    error = SOLOMotorControllers::Error::noProcessedCommand;
    if(comIf->CANOpenReceive(Address, Object_MotorType, 0x00, informationToSend, informationReceived, error)){
        return ( soloUtils->ConvertToLong(informationReceived) ) ;
    }
    return -1;
}
...
long SOLOMotorControllersCanopen::GetFeedbackControlMode(int &error)
{
    ...
    uint8_t  informationReceived[4] = {0x00,0x00,0x00,0x00};
    error = SOLOMotorControllers::Error::noProcessedCommand;
    if(comIf->CANOpenReceive(Address, Object_FeedbackControlMode, 0x00, informationToSend, informationReceived, error)){
        return ( soloUtils->ConvertToLong(informationReceived) ) ;
    }
    return -1;
}
...
long SOLOMotorControllersCanopen::GetCommandMode(int &error)
{
    ...
    uint8_t  informationReceived[4] = {0x00,0x00,0x00,0x00};
    error = SOLOMotorControllers::Error::noProcessedCommand;
    if(comIf->CANOpenReceive(Address, Object_CommandMode, 0x00, informationToSend, informationReceived, error)){
        return ( soloUtils->ConvertToLong(informationReceived) ) ;
    }
    return -1;
}
...
long SOLOMotorControllersCanopen::GetControlMode(int &error)
{
    ...
    uint8_t  informationReceived[4] = {0x00,0x00,0x00,0x00};
    error = SOLOMotorControllers::Error::noProcessedCommand;
    if(comIf->CANOpenReceive(Address, Object_ControlMode, 0x00, informationToSend, informationReceived, error)){
        return ( soloUtils->ConvertToLong(informationReceived) ) ;
    }
    return -1;
}
...
long SOLOMotorControllersCanopen::GetSpeedLimit(int &error)
{
    ...
    uint8_t  informationReceived[4] = {0x00,0x00,0x00,0x00};
    error = SOLOMotorControllers::Error::noProcessedCommand;
    if(comIf->CANOpenReceive(Address, Object_SpeedLimit, 0x00, informationToSend, informationReceived, error)){
        return ( soloUtils->ConvertToLong(informationReceived) ) ;
    }
    return -1;
}
...
float SOLOMotorControllersCanopen::GetPositionControllerKp(int &error)
{
    ...
    uint8_t  informationReceived[4] = {0x00,0x00,0x00,0x00};
    error = SOLOMotorControllers::Error::noProcessedCommand;
    if(comIf->CANOpenReceive(Address, Object_PositionControllerKp, 0x00, informationToSend, informationReceived, error)){
        return ( soloUtils->ConvertToFloat(informationReceived) ) ;
    }
    return -1.0;
}
...
float SOLOMotorControllersCanopen::GetPositionControllerKi(int &error)
{
    ...
    uint8_t  informationReceived[4] = {0x00,0x00,0x00,0x00};
    error = SOLOMotorControllers::Error::noProcessedCommand;
    if(comIf->CANOpenReceive(Address, Object_PositionControllerKi, 0x00, informationToSend, informationReceived, error)){
        return ( soloUtils->ConvertToFloat(informationReceived) ) ;
    }
    return -1.0;
}
...
long SOLOMotorControllersCanopen::GetPositionCountsFeedback(int &error)
{
    ...
    uint8_t  informationReceived[4] = {0x00,0x00,0x00,0x00};
    error = SOLOMotorControllers::Error::noProcessedCommand;
    if(comIf->CANOpenReceive(Address, Object_PositionCountsFeedback, 0x00, informationToSend, informationReceived, error)){
        return ( soloUtils->ConvertToLong(informationReceived) ) ;
    }
    return -1 ;
}
...
long SOLOMotorControllersCanopen::GetErrorRegister(int &error)
{
    ...
    uint8_t  informationReceived[4] = {0x00,0x00,0x00,0x00};
    error = SOLOMotorControllers::Error::noProcessedCommand;
    if(comIf->CANOpenReceive(Address, Object_OverwriteErrorRegister, 0x00, informationToSend, informationReceived, error)){
        return ( soloUtils->ConvertToLong(informationReceived) ) ;
    }
    return -1 ;
}
...
long SOLOMotorControllersCanopen::GetDeviceFirmwareVersion(int &error)
{
    ...
    uint8_t  informationReceived[4] = {0x00,0x00,0x00,0x00};
    error = SOLOMotorControllers::Error::noProcessedCommand;
    if(comIf->CANOpenReceive(Address, Object_DeviceFirmwareVersion, 0x00, informationToSend, informationReceived, error)){
        return ( soloUtils->ConvertToLong(informationReceived) ) ;
    }
    return -1 ;
}
...
long SOLOMotorControllersCanopen::GetDeviceHardwareVersion(int &error)
{
    ...
    uint8_t  informationReceived[4] = {0x00,0x00,0x00,0x00};
    error = SOLOMotorControllers::Error::noProcessedCommand;
    if(comIf->CANOpenReceive(Address, Object_DeviceHardwareVersion, 0x00, informationToSend, informationReceived, error)){
        return ( soloUtils->ConvertToLong(informationReceived) ) ;
    }
    return -1 ;
}
...
float SOLOMotorControllersCanopen::GetTorqueReferenceIq(int &error)
{
    ...
    uint8_t  informationReceived[4] = {0x00,0x00,0x00,0x00};
    error = SOLOMotorControllers::Error::noProcessedCommand;
    if(comIf->CANOpenReceive(Address, Object_TorqueReferenceIq, 0x00, informationToSend, informationReceived, error)){
        return ( soloUtils->ConvertToFloat(informationReceived) ) ;
    }
    return -1.0 ;
}
...
long SOLOMotorControllersCanopen::GetSpeedReference(int &error)
{
    ...
    uint8_t  informationReceived[4] = {0x00,0x00,0x00,0x00};
    error = SOLOMotorControllers::Error::noProcessedCommand;
    if(comIf->CANOpenReceive(Address, Object_SpeedReference, 0x00, informationToSend, informationReceived, error)){
        return ( soloUtils->ConvertToLong(informationReceived) ) ;
    }
    return -1 ;
}
...
long SOLOMotorControllersCanopen::GetPositionReference(int &error)
{
    ...
    uint8_t  informationReceived[4] = {0x00,0x00,0x00,0x00};
    error = SOLOMotorControllers::Error::noProcessedCommand;
    if(comIf->CANOpenReceive(Address, Object_PositionReference, 0x00, informationToSend, informationReceived, error)){
        return ( soloUtils->ConvertToLong(informationReceived) ) ;
    }
    return -1 ;
}
...
float SOLOMotorControllersCanopen::GetPowerReference(int &error)
{
    ...
    uint8_t  informationReceived[4] = {0x00,0x00,0x00,0x00};
    error = SOLOMotorControllers::Error::noProcessedCommand;
    if(comIf->CANOpenReceive(Address, Object_PowerReference, 0x00, informationToSend, informationReceived, error)){
        return ( soloUtils->ConvertToFloat(informationReceived) ) ;
    }
    return -1.0 ;
}
...
long SOLOMotorControllersCanopen::GetMotorDirection(int &error)
{
    ...
    uint8_t  informationReceived[4] = {0x00,0x00,0x00,0x00};
    error = SOLOMotorControllers::Error::noProcessedCommand;
    if(comIf->CANOpenReceive(Address, Object_MotorDirection, 0x00, informationToSend, informationReceived, error)){
        return ( soloUtils->ConvertToLong(informationReceived) ) ;
    }
    return -1 ;
}
...
float SOLOMotorControllersCanopen::GetObserverGainBldcPmsm(int &error)
{
    ...
    uint8_t  informationReceived[4] = {0x00,0x00,0x00,0x00};
    error = SOLOMotorControllers::Error::noProcessedCommand;
    if(comIf->CANOpenReceive(Address, Object_ObserverGainBldcPmsm, 0x00, informationToSend, informationReceived, error)){
        return ( soloUtils->ConvertToFloat(informationReceived) ) ;
    }
    return -1.0 ;
}
...
float SOLOMotorControllersCanopen::GetObserverGainBldcPmsmUltrafast(int &error)
{
    ...
    uint8_t  informationReceived[4] = {0x00,0x00,0x00,0x00};
    error = SOLOMotorControllers::Error::noProcessedCommand;
    if(comIf->CANOpenReceive(Address, Object_ObserverGainBldcPmsmUltrafast, 0x00, informationToSend, informationReceived, error)){
        return ( soloUtils->ConvertToFloat(informationReceived) ) ;
    }
    return -1.0 ;
}
...
float SOLOMotorControllersCanopen::GetObserverGainDc(int &error)
{
    ...
    uint8_t  informationReceived[4] = {0x00,0x00,0x00,0x00};
    error = SOLOMotorControllers::Error::noProcessedCommand;
    if(comIf->CANOpenReceive(Address, Object_ObserverGainDc, 0x00, informationToSend, informationReceived, error)){
        return ( soloUtils->ConvertToFloat(informationReceived) ) ;
    }
    return -1.0 ;
}
...
float SOLOMotorControllersCanopen::GetFilterGainBldcPmsm(int &error)
{
    ...
    uint8_t  informationReceived[4] = {0x00,0x00,0x00,0x00};
    error = SOLOMotorControllers::Error::noProcessedCommand;
    if(comIf->CANOpenReceive(Address, Object_FilterGainBldcPmsm, 0x00, informationToSend, informationReceived, error)){
        return ( soloUtils->ConvertToFloat(informationReceived) ) ;
    }
    return -1.0 ;
}
...
float SOLOMotorControllersCanopen::GetFilterGainBldcPmsmUltrafast(int &error)
{
    ...
    uint8_t  informationReceived[4] = {0x00,0x00,0x00,0x00};
    error = SOLOMotorControllers::Error::noProcessedCommand;
    if(comIf->CANOpenReceive(Address, Object_FilterGainBldcPmsmUltrafast, 0x00, informationToSend, informationReceived, error)){
        return ( soloUtils->ConvertToFloat(informationReceived) ) ;
    }
    return -1.0 ;
}
...
float SOLOMotorControllersCanopen::Get3PhaseMotorAngle(int &error)
{
    ...
    uint8_t  informationReceived[4] = {0x00,0x00,0x00,0x00};
    error = SOLOMotorControllers::Error::noProcessedCommand;
    if(comIf->CANOpenReceive(Address, Object_3PhaseMotorAngle, 0x00, informationToSend, informationReceived, error)){
        return ( soloUtils->ConvertToFloat(informationReceived) ) ;
    }
    return -1.0 ;
}
...
float SOLOMotorControllersCanopen::GetEncoderHallCcwOffset(int &error)
{
    ...
    uint8_t  informationReceived[4] = {0x00,0x00,0x00,0x00};
    error = SOLOMotorControllers::Error::noProcessedCommand;
    if(comIf->CANOpenReceive(Address, Object_EncoderHallCcwOffset, 0x00, informationToSend, informationReceived, error)){
        return ( soloUtils->ConvertToFloat(informationReceived) ) ;
    }
    return -1.0 ;
}
...
float SOLOMotorControllersCanopen::GetEncoderHallCwOffset(int &error)
{
    ...
    uint8_t  informationReceived[4] = {0x00,0x00,0x00,0x00};
    error = SOLOMotorControllers::Error::noProcessedCommand;
    if(comIf->CANOpenReceive(Address, Object_EncoderHallCwOffset, 0x00, informationToSend, informationReceived, error)){
        return ( soloUtils->ConvertToFloat(informationReceived) ) ;
    }
    return -1.0 ;
}
...
long SOLOMotorControllersCanopen::GetUartBaudrate(int &error)
{
    ...
    uint8_t  informationReceived[4] = {0x00,0x00,0x00,0x00};
    error = SOLOMotorControllers::Error::noProcessedCommand;
    if(comIf->CANOpenReceive(Address, Object_UartBaudrate, 0x00, informationToSend, informationReceived, error)){
        return ( soloUtils->ConvertToLong(informationReceived) ) ;
    }
    return -1 ;
}
...
float SOLOMotorControllersCanopen::GetSpeedAccelerationValue(int &error)
{
    ...
    uint8_t  informationReceived[4] = {0x00,0x00,0x00,0x00};
    error = SOLOMotorControllers::Error::noProcessedCommand;
    if(comIf->CANOpenReceive(Address, Object_SpeedAccelerationValue, 0x00, informationToSend, informationReceived, error)){
        return ( soloUtils->ConvertToFloat(informationReceived) ) ;
    }
    return -1.0 ;
}
...
float SOLOMotorControllersCanopen::GetSpeedDecelerationValue(int &error)
{
    ...
    uint8_t  informationReceived[4] = {0x00,0x00,0x00,0x00};
    error = SOLOMotorControllers::Error::noProcessedCommand;
    if(comIf->CANOpenReceive(Address, Object_SpeedDecelerationValue, 0x00, informationToSend, informationReceived, error)){
        return ( soloUtils->ConvertToFloat(informationReceived) ) ;
    }
    return -1.0 ;
}
...
long  SOLOMotorControllersCanopen::GetCanbusBaudrate(int &error)
{
    ...
    uint8_t  informationReceived[4] = {0x00,0x00,0x00,0x00};
    error = SOLOMotorControllers::Error::noProcessedCommand;
    if(comIf->CANOpenReceive(Address, Object_CanbusBaudrate, 0x00, informationToSend, informationReceived, error)){
        return ( soloUtils->ConvertToLong(informationReceived) ) ;
    }
    return -1.0 ;
}
...
long SOLOMotorControllersCanopen::GetAnalogueSpeedResolutionDivisionCoefficient(int &error)
{
    ...
    uint8_t  informationReceived[4] = {0x00,0x00,0x00,0x00};
    error = SOLOMotorControllers::Error::noProcessedCommand;
    if(comIf->CANOpenReceive(Address, Object_ASRDC, 0x00, informationToSend, informationReceived, error)){
        return ( soloUtils->ConvertToLong(informationReceived) ) ;
    }
    return -1 ;
}
...
long SOLOMotorControllersCanopen::GetEncoderIndexCounts(int &error)
{
    ...
    uint8_t  informationReceived[4] = {0x00,0x00,0x00,0x00};
    error = SOLOMotorControllers::Error::noProcessedCommand;
    if(comIf->CANOpenReceive(Address, Object_EncoderIndexCounts, 0x00, informationToSend, informationReceived, error)){
        return ( soloUtils->ConvertToLong(informationReceived) ) ;
    }
    return -1 ;
...
long SOLOMotorControllersCanopen::GetMotionProfileMode(int &error)
{
    ...
    uint8_t  informationReceived[4] = {0x00,0x00,0x00,0x00};
    error = SOLOMotorControllers::Error::noProcessedCommand;
    if(comIf->CANOpenReceive(Address, Object_MotionProfileMode, 0x00, informationToSend, informationReceived, error)){
        return ( soloUtils->ConvertToFloat(informationReceived) ) ;
    }
    return -1 ;
}
...
float SOLOMotorControllersCanopen::GetMotionProfileVariable1(int &error)
{
    ...
    uint8_t  informationReceived[4] = {0x00,0x00,0x00,0x00};
    error = SOLOMotorControllers::Error::noProcessedCommand;
    if(comIf->CANOpenReceive(Address, Object_MotionProfileVariable1, 0x00, informationToSend, informationReceived, error)){
        return ( soloUtils->ConvertToFloat(informationReceived) ) ;
    }
    return -1 ;
}
...
float SOLOMotorControllersCanopen::GetMotionProfileVariable2(int &error)
{
    ...
    uint8_t  informationReceived[4] = {0x00,0x00,0x00,0x00};
    error = SOLOMotorControllers::Error::noProcessedCommand;
    if(comIf->CANOpenReceive(Address, Object_MotionProfileVariable2, 0x00, informationToSend, informationReceived, error)){
        return ( soloUtils->ConvertToFloat(informationReceived) ) ;
    }
    return -1 ;
}
...
float SOLOMotorControllersCanopen::GetMotionProfileVariable3(int &error)
{
    ...
    uint8_t  informationReceived[4] = {0x00,0x00,0x00,0x00};
    error = SOLOMotorControllers::Error::noProcessedCommand;
    if(comIf->CANOpenReceive(Address, Object_MotionProfileVariable3, 0x00, informationToSend, informationReceived, error)){
        return ( soloUtils->ConvertToFloat(informationReceived) ) ;
    }
    return -1 ;
}
...
float SOLOMotorControllersCanopen::GetMotionProfileVariable4(int &error)
{
    ...
    uint8_t  informationReceived[4] = {0x00,0x00,0x00,0x00};
    error = SOLOMotorControllers::Error::noProcessedCommand;
    if(comIf->CANOpenReceive(Address, Object_MotionProfileVariable4, 0x00 , informationToSend, informationReceived, error)){
        return ( soloUtils->ConvertToFloat(informationReceived) ) ;
    }
    return -1 ;
}
...
float SOLOMotorControllersCanopen::GetMotionProfileVariable5(int &error)
{
    ...
    uint8_t  informationReceived[4] = {0x00,0x00,0x00,0x00};
    error = SOLOMotorControllers::Error::noProcessedCommand;
    if(comIf->CANOpenReceive(Address, Object_MotionProfileVariable5, 0x00 , informationToSend, informationReceived, error)){
        return ( soloUtils->ConvertToFloat(informationReceived) ) ;
    }
    return -1 ; 
}
